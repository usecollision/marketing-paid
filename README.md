...
The **demand** layer of the UseCollision Marketing OS. Paid acquisition end to end: strategy, ad creative, platform execution, and the ecommerce vertical that depends on them.

Merged from: `marketing-paid` + `marketing-ad-creative` + `marketing-ecommerce` (Aug 2026).

## Skills

| Skill | Category | What it does |
|---|---|---|
| [paid-strategy](paid-strategy/SKILL.md) | paid | Build a multi-platform paid media strategy with budget allocation, platform selection, and funnel design. |
| [meta-ads](meta-ads/SKILL.md) | paid | Set up, structure, and optimize Meta (Facebook/Instagram) ad campaigns from scratch. |
...
- `marketing-intelligence` (ICP, positioning, research — via related refs)
- `marketing-messaging` (copy → creative)
